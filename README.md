...
#### Классы OrderForm, UserForm, ResultForm
Являются наследниками класса Form и служат для заполнения форм с методом оплаты, контактных данных и вывода результатов оплаты.
...
- `FormUser:submit` - сохранение контактов пользователя в модальном окне и отправка на сервер
